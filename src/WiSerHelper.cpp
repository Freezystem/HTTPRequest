...
String WiSerHelper::statusToString(HttpCode code){
  String statuses[40] = {
    "Continue",
    "Switching Protocols",
    "OK",
...
String WiSerHelper::statusToCodeString(HttpCode code){
  return statuses[(int)code];
}

String WiSerHelper::methodToString(HttpMethod method){
  return methods[(int)method];
}

HttpCode WiSerHelper::codeStringToStatus(String code){
  int i = 40;
  bool searching = true;
...
HttpMethod WiSerHelper::stringToMethod(String method){
  int i = 8;
  bool searching = true;
